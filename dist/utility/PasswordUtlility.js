...
const GenerateSignature = (payload) => {
    return jsonwebtoken_1.default.sign(payload, config_1.config.APP_SECRET, { expiresIn: '2d' });
};
exports.GenerateSignature = GenerateSignature;
const ValidateSignature = (req) => {
    const signature = req.get('Authorization');
    if (signature) {
        const payload = jsonwebtoken_1.default.verify(signature.split(' ')[1], config_1.config.APP_SECRET);
        req.user = payload;
        return true;
    }
};
exports.ValidateSignature = ValidateSignature;
//# sourceMappingURL=PasswordUtlility.js.map